                    ...
                    return(
                        <div className="weather-wrapper" key={key}>
                            ...
                            <div className="bottom-condition-container">
                                <h6><span className="title">Wind</span>{Math.floor(weather.wind_mph)}</h6>
                                <h6><span className="title">Gusts</span>{Math.floor(weather.gust_mph)}</h6>
                                <h6><span className="title">Rain</span>{Math.floor(weather.chance_of_rain)}</h6>
                            </div>
                        </div>
                    )
                })
